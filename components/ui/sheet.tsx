...
interface SheetOverlayProps extends ComponentPropsWithoutRef<
...
interface SheetContentProps extends ComponentPropsWithoutRef<
...
interface SheetHeaderProps extends ComponentPropsWithoutRef<
  typeof SheetPrimitive.DialogTitle
> {
  className?: string
}
