        ...
        >
          <div className="text-center xl:text-left order-2 lg:order-none">
            ...
            <h1 className="h1 mb-6">
              Hello I'm <br />{' '}
              <span className="text-accent">Andrii Dmytruk</span>
            </h1>
            <p className="max-w-[500px] mb-9 text-white/80">
              I’m a junior frontend developer focused on building responsive,
              accessible, and modern web interfaces. I work with technologies
              like HTML, CSS, JavaScript, TypeScript, React, Redux Toolkit,
              Next.js, and Tailwind CSS. I'm passionate about clean code, good
              UI/UX, and constantly improving my skills through practice and
              learning.
            </p>
